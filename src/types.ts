...
export enum Packages {
	...
	Cors = 'cors',
	Dotenv = 'dotenv',
	EmotionReact = 'emotion_react',
	EmotionStyled = 'emotion_styled',
	Express = 'express',
	Graphql = 'graphql',
...
export type AuthenticationstatusResolvers<
	ContextType = any,
	ParentType extends ResolversParentTypes['Authenticationstatus'] = ResolversParentTypes['Authenticationstatus'],
> = {
...
export type KanbanCardResolvers<
	ContextType = any,
	ParentType extends ResolversParentTypes['KanbanCard'] = ResolversParentTypes['KanbanCard'],
> = {
...
> = {
	...
	createKanban?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationCreateKanbanArgs, 'createdBy' | 'project'>
	>;
	...
	editKanban?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationEditKanbanArgs, '_id'>
	>;
...
> = {
	...
	searchArticleByTitle?: Resolver<
		Maybe<ResolversTypes['ID']>,
		ParentType,
		ContextType,
		Partial<QuerySearchArticleByTitleArgs>
	>;
	searchArticlesByTag?: Resolver<
		Maybe<Array<Maybe<ResolversTypes['Article']>>>,
		ParentType,
		ContextType,
		Partial<QuerySearchArticlesByTagArgs>
	>;
	searchProject?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType, Partial<QuerySearchProjectArgs>>;
	searchProjectsByTag?: Resolver<
		Maybe<Array<Maybe<ResolversTypes['Project']>>>,
		ParentType,
		ContextType,
		Partial<QuerySearchProjectsByTagArgs>
	>;
};

export type TagWithTypeResolvers<
	ContextType = any,
	ParentType extends ResolversParentTypes['TagWithType'] = ResolversParentTypes['TagWithType'],
> = {
