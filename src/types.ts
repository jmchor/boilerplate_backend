...
export type PackagesResolvers = EnumResolverSignature<{ GRAPHQL_CODEGEN_CLI?: any, GRAPHQL_CODEGEN_TYPESCRIPT?: any, GRAPHQL_CODEGEN_TYPESCRIPT_RESOLVERS?: any, apolloClient?: any, apolloServer?: any, bcryptjs?: any, bcryptts?: any, cors?: any, dotenv?: any, express?: any, graphql?: any, graphqlTag?: any, jsonwebtoken?: any, mongoose?: any, nodemon?: any, pg?: any, tsup?: any, tsx?: any, typesBcryptjs?: any, typesCors?: any, typesExpress?: any, typesJsonwebtoken?: any, typesNode?: any, typesNodemon?: any, typesPg?: any, typescript?: any }, ResolversTypes['Packages']>;
